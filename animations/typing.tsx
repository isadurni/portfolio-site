...
// The cursor blinker now matches the font size and line height of its parent
function CursorBlinker({ className }: { className?: string }) {
  return (
    <motion.span
      ...
      animate="blinking"
      // Use 'align-baseline' and 'h-[1em]' to match font size, and remove translate-y
      className={cn(
        'inline-block align-baseline h-[1em] w-[1px] bg-black dark:bg-white translate-y-1',
        className,
      )}
    />
  );
